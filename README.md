...
of the gamess-roll.  To avoid cluttering the cluster frontend with unused
software, the gamess-roll is configured to install only on compute and
login nodes. To force installation on your frontend, run this command after
adding the gamess-roll to your distro

```shell
% rocks run roll gamess host=NAME | bash
```

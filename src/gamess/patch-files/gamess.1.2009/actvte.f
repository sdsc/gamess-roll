...
C         CRAY T3E,T90,X1 SYSTEM            TURN ON '*UNX' AND '*CRY'
...
c
*CRY  END
*CRY  SUBROUTINE GETENV(NAME,VALUE)
*CRY  CHARACTER*(*) NAME,VALUE
*CRY  LENNAM = LEN(NAME)
*CRY  CALL PXFGETENV(NAME,LENNAM,VALUE,LENVAL,IERROR)
*CRY  RETURN
      END
